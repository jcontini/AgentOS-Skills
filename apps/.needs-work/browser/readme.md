...
The Browser app is **view-only**. It displays what AI agents do with web capabilities:
...
Activity Log: {capability: "web_search", request: {...}, response: [...]}
     ↓
Browser App: Shows search results in classic UI
```
...
The Browser app doesn't fetch data directly. It subscribes to activities:

```typescript
// Browser app subscribes to web activities
