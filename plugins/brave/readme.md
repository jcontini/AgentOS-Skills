...
```bash
# Basic search
UsePlugin(plugin: "brave", tool: "webpage.search", params: {query: "rust programming"})

# With freshness filter
UsePlugin(plugin: "brave", tool: "webpage.search", params: {query: "AI news", freshness: "pw"})

# Site-specific search
UsePlugin(plugin: "brave", tool: "webpage.search", params: {query: "site:github.com rust web framework"})
```
